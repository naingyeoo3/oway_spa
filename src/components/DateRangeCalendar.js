...
const defaultProps = {    
  ...
  isDayBlocked: () => false,
  isOutsideRange: day => !isInclusivelyAfterDay(day, moment().format('HH') > 19 ? moment().add(2,'days') : moment().add(1, 'days')),
  isDayHighlighted: () => false,  
  monthFormat: 'MMMM YYYY',
  displayFormat: dateFormat,
  initialStartDate: moment().format('HH') > 19 ? moment().add(2,'days') : moment().add(1, 'days'), // when pass 8pm, set next day 
  initialEndDate: moment().format('HH') > 19 ? moment().add(2,'days') : moment().add(1, 'days'), // when pass 8pm, set next day 
