...
const defaultProps = {    
  ...
  isDayBlocked: () => false,
  isOutsideRange: day => !isInclusivelyAfterDay(day, moment().format('HH') > 16 ? moment().add(3, 'days') : moment().add(2, 'days')),
  isDayHighlighted: () => false,  
  monthFormat: 'MMMM YYYY',
  displayFormat: dateFormat,
  initialStartDate: moment().format('HH') > 16 ? moment().add(3, 'days') : moment().add(2, 'days'),
  initialEndDate: moment().format('HH') > 16 ? moment().add(4,'days') : moment().add(3,'days'),
  customArrowIcon: <div className='vertical-line'/>,
}

class BusDateRangeCalendar extends React.Component {
  constructor(props) {
    super(props);
...
BusDateRangeCalendar.defaultProps = defaultProps;

export default BusDateRangeCalendar;