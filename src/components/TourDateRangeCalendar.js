...
const defaultProps = {    
  ...
  initialStartDate: moment().format('HH') > 16 ? moment().add(6,'days') : moment().add(5, 'days'),
  initialEndDate: moment().format('HH') > 16 ? moment().add(6,'days') : moment().add(5, 'days'),
  customArrowIcon: <div className='vertical-line'/>,
}


class TourDateRangeCalendar extends React.Component {
  constructor(props) {
    super(props);
...
TourDateRangeCalendar.defaultProps = defaultProps;

export default TourDateRangeCalendar;