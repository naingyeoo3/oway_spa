...
import './tour-listing-item.scss';
import { Tooltip, Button }from 'antd'
 
class TourListingItem extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    render() { 
        ...
        return (
            <Link to={`/tours/search/detail/${item.code}`}>
...
export default connect(mapStateToProps, mapDispatchToProps)(TourListingItem)