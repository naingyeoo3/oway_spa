...
import CarProductCarousel from './CarProductCarousel';

class CarRentalPage extends Component {
    constructor(props){
        super(props);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(CarRentalPage);