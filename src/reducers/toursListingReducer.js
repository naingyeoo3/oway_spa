...
function tourListing(state = INITIAL_STATE, action){
    switch (action.type) {
        case actions.LOAD_TOUR_FILTER:
            return Object.assign({}, state, {
                isLoadFilter: true
            })
        case actions.REQUEST_TOUR_LISTING:
            return Object.assign({}, state, {              
                isFetching: true
            })
        case actions.RECEIVE_TOUR_LISTING:                         
            return Object.assign({}, state, {                
                isFetching: false,
        ...
        case actions.RECEIVE_TOUR_LISTING_ERROR:
            return Object.assign({}, state, {
                isFetching: false,
                data: [],
                meta: null,
        ...
        case actions.LOAD_MORE_TOUR:
            return Object.assign({}, state, {
                // isFetching: true
            })
        case actions.RECEIVE_TOUR_LOAD_MORE:            
            return Object.assign({}, state, {
                // isFetching: false,
        ...
        case actions.RESET_TOUR_FILTER:
            return Object.assign({}, state, {
                filter: []
            })
        case actions.REQUEST_SORT_PRICE_ASC:
            return Object.assign({}, state, {
                isFetching: true
            })
        case actions.SORT_PRICE_ASC:
            return Object.assign({}, state, {
                isFetching: false,
        ...
        case actions.REQUEST_SORT_PRICE_DEC:
            return Object.assign({}, state, {
                isFetching: true
            })
        case actions.SORT_PRICE_DEC:
            return Object.assign({}, state, {
                isFetching: false,
        ...
        case actions.REQUEST_SORT_DISCOUNT_ACE:
            return Object.assign({}, state, {
                isFetching: true
            })
        case actions.RECEIVE_SORT_DISCOUNT_ACE:            
            return Object.assign({}, state, {
                isFetching: false,
        ...
        case actions.REQUEST_SORT_DISCOUNT_DEC:
            return Object.assign({}, state, {
                isFetching: true
            })
        case actions.RECEIVE_SORT_DISCOUNT_DEC:
            return Object.assign({}, state, {
                isFetching: false,
        ...
        case actions.REQUEST_SORT_RECOMMENDED_ACE:
            return Object.assign({}, state, {
                isFetching: true
            })
        case actions.RECEIVE_SORT_RECOMMENDED_ACE:
            return Object.assign({}, state, {
                isFetching: false,
        ...
        case actions.REQUEST_SORT_RECOMMENDED_DEC:
            return Object.assign({}, state, {
                isFetching: true
            })
        case actions.RECEIVE_SORT_RECOMMENDED_DEC:
            return Object.assign({}, state, {
                isFetching: false,
        ...
        case actions.REQUEST_TOUR_DETAIL:
            return Object.assign({}, state, {
                detail: {
                    isFetching: true,
                    data: null
        ...
        case actions.RECEIVE_TOUR_DETAIL:
            return Object.assign({}, state, {
                detail: {
                    isFetching: false,
                    data: action.payload
        ...
        case actions.REQUEST_CATEGORY_FILTER:
            return Object.assign({}, state, {
                filterCategories: {
                    isFetching: true,
                    data: []
        ...
        case actions.RECEIVE_CATEGORY_FILTER:
            return Object.assign({}, state, {
                filterCategories: {
                    isFetching: false,
        ...
        case actions.REQUEST_FILTER_TOUR_SEARCH:
            return Object.assign({}, state, {              
                isFetching: true
            })
        case actions.RECEIVE_FILTER_TOUR_SEARCH:                         
            return Object.assign({}, state, {                
                isFetching: false,
                totalData: state.totalData, 
                meta: null,
